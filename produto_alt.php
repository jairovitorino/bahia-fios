...
<table width="85%" border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <?php
   ...
   $mysql = new Mysql();
   $mysql->conectar();
  $sql = mysql_query("SELECT * FROM produtos WHERE id_produto = ".$id_produto." ");
  $row = mysql_num_rows($sql);
  for ( $i=0; $i < $row; $i++ ){
  $id_produto = mysql_result($sql, $i, "id_produto");
   $nm_produto = mysql_result($sql, $i, "nm_produto");
   $nm_produto1 = mysql_result($sql, $i, "nm_produto1");
   $pc_produto = mysql_result($sql, $i, "pc_produto");
   }
  ?>
  <tr> 
    <td class="labelDireita">Nome:</td>
    <td class="labelEsquerda"><input name="nm_produto" id="nm_produto" value="<?php echo $nm_produto;?>" type="text" size="50" maxlength="50"></td>
  </tr>
  <tr>
      <td class="labelDireita">C&oacute;digo:</td>
      <td class="labelEsquerda"><input name="nm_produto1" type="text" value="<?php echo $nm_produto1;?>" onKeyPress="formatar(this,'###.#######')" size="20" maxlength="11"></td>
    </tr>
  <tr> 
    <td class="labelDireita">Percentual (%):</td>
    <td class="labelEsquerda"><input name="pc_produto" type="text" value="<?php echo $pc_produto;?>" size="8" maxlength="3"></td>
  </tr>
  <tr> 
    <td class="labelDireita">&nbsp;</td>
    <td class="labelEsquerda"><input type="hidden" name="alterarProduto">
        <input type="hidden" name="id_produto" value="<?php echo $id_produto;?>"></td>
  </tr>
  <tr>
    <td colspan="2" class="labelCentro"><hr></td>
  </tr>
  <tr> 
    <td colspan="2" class="labelCentro"><input type="submit" name="grava" value="Alterar Produto"> 
